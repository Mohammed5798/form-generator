      ...
      {/* Navbar */}
        ...
        <div className='flex flex-col items-center justify-start py-4'>
            ...
            <div className="boxes-container flex space-x-16">
                {/* QR Section */}
                <div className="box border max-[725px]:py-0 border-gray-300 w-78 rounded-lg p-12 flex flex-col items-center">
                ...
                {/* Link Section */}
                <div className="box border border-gray-300 w-78 rounded-lg p-10 flex flex-col items-start space-y-3">
